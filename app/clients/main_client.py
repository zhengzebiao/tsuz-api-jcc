...
class MainClient:
    ...
    def report_permissions(
        ...
        *,
        ...
        headers = {
            "Authorization": f"Bearer {self._service_token(self.PERMISSION_REPORT_SCOPE)}",
        ...
        try:
            response = self._client.put(
                f"{settings.main_api_base_url.rstrip('/')}/internal/v1/permissions/report",
                headers=headers,
            ...
            logger.warning("permission report request failed reason=upstream_error")
